...
import 'package:bloc_weather_app/WeatherBloc.dart';
...
class SearchPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // ignore: close_sinks
    final weatherBloc = BlocProvider.of<WeatherBloc>(context); //to refer your bloc
        ...
        BlocBuilder<WeatherBloc, WeatherState>(
          builder: (context, state){
            ...
            if(state is WeatherIsNotSearched)
              ...
              return Center(child: Text("Error",style: TextStyle(color: Colors.white, fontSize: 25),));
          },
        )
